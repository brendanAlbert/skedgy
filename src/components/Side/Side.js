            ...
            { context => (
                <Fragment>
                    <div className="side-container">
                        ...
                        <p className="side-btn" onClick={ () => context.showScreen('choiceSchedule')}>create a 1st, 2nd, 3rd, 4th choice schedule</p>
                        <p className="side-btn" onClick={ () => context.showScreen('classesByTeacher')}>see all classes offered by a teacher</p>
                        <p className="side-btn" onClick={ () => context.showScreen('classesByTime')}>see all classes offered @ x time</p>
                        <p className="side-btn" onClick={ () => context.showScreen('classesByAGRequirement')}>
                            see all classes offered which fulfill a certain A-G
                            requirement
                        </p>

                        <h3>when building a schedule i want to:</h3>
                        <p className="side-btn" onClick={ () => context.showScreen('chooseFromAvailable')}>choose from available 0-6 period classes</p>
                    </div>
                </Fragment>
            )}
        </SkedgyContext.Consumer>
